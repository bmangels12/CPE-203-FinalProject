   ...
   public boolean processLine(String line, ImageStore imageStore) {
      ...
      if (properties.length > 0) {
         switch (properties[PROPERTY_KEY]) {
            ...
            case OCTO_KEY:
               return WorldFactory.parseOcto(properties, imageStore, this);
            case OBSTACLE_KEY:
               return WorldFactory.parseObstacle(properties, imageStore, this);
            case FISH_KEY:
               return WorldFactory.parseFish(properties, imageStore, this);
            case ATLANTIS_KEY:
               return WorldFactory.parseAtlantis(properties, imageStore, this);
            case SGRASS_KEY:
               return WorldFactory.parseSgrass(properties, imageStore, this);
         }
      }
      return false;
   }
