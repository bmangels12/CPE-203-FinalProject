...
//
//      Point MousePoint = view.getViewport().viewportToWorld(mouseX/TILE_WIDTH, mouseY/TILE_HEIGHT);
//
//      Fish test = new Fish(MousePoint, imageStore.getImageList(FISH_KEY), FISH_ACTION_PERIOD);
//      if (!(world.isOccupied(MousePoint))) {
